...
class _WalletScreenState extends State<WalletScreen> {
  ...
  Future<void> _fundWallet() async {
    ...
    try {
      final newBalance =
          await context.read<WalletProvider>().fundWallet(amount);
      context.read<AuthProvider>().updateWalletBalance(newBalance);

      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content: Text("Wallet funded with N$amount!"),
            backgroundColor: AppColors.success),
      );

      _amountController.clear();
      setState(() {
        _showFundInput = false;
        _isFunding = false;
      });
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: const Text("My Wallet"), backgroundColor: AppColors.primary),
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Column(children: [
                  Icon(Icons.account_balance_wallet,
                      color: Colors.white.withValues(alpha: 0.8), size: 40.sp),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    border: Border.all(color: AppColors.border)),
                child: Column(children: [
                  _infoRow(Icons.person, "Account Name",
                  ...
                  _divider(),
                  _infoRow(Icons.badge, "Account Type",
