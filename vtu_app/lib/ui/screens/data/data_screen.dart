              ...
              Container(
                ...
                child: Column(children: _dataPlans.map((plan) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      padding: EdgeInsets.all(16.w),
                      decoration: BoxDecoration(color: sel ? AppColors.primary.withValues(alpha: 0.05) : null, border: const Border(bottom: BorderSide(color: AppColors.divider))),
                      child: Row(children: [
